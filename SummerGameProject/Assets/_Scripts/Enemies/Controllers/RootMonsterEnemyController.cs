...
public class RootMonsterEnemyController : EnemyController, IDamageable
{
    ...
    protected override void ConstructFSM()
    {
        ...
        RootMonster_IdleState idleState = new RootMonster_IdleState(this, animator);

        RootMonster_CooldownState cooldownState = new RootMonster_CooldownState(0.5f, animator, this);

        RootMonster_EarthBarrageState earthBarrageState = new RootMonster_EarthBarrageState(this, animator);

        RootMonster_RootSpearsState rootSpearsState = new RootMonster_RootSpearsState(this, animator);
    ...
    public void SpawnProjectiles(RootMonster_EarthBarrageState barrageState)
    {
        StartCoroutine(SpawnProjectilesCoroutine(barrageState));
    }


    private IEnumerator SpawnProjectilesCoroutine(RootMonster_EarthBarrageState barrageState)
    {
    ...
    public void LaunchProjectiles(RootMonster_EarthBarrageState barrageState)
    {
    ...
    public void SpawnRootSpears(RootMonster_RootSpearsState rootSpearsState)
    {
    ...
    private IEnumerator SpawnProjectilesCoroutine(RootMonster_RootSpearsState rootSpearsState)
    {
        ...
        for (int i = 0; i < _rootSpearCount; i++)
        {
            ...
            rootSpearsState.ProjectileGOs[i].GetComponent<RootMonster_RootSpearProjectile>().Initialize(rootSpearsState,this, 0);
